...
public class GenCodeUtil {
    ...
    public static void main(String[] args) throws IOException {
        genFiles("YuSai", "dict", "com.asteroid.expression.common.base","com.asteroid.expression.dict", "/resources/mybatis/mapper","Dict", "QueryDict", "application.properties");
    }
